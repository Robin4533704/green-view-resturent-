...
const BLogimg = () => {
  ...
  <div className="bg-orange-300 p-6 gap-6 md:gap-12 flex flex-col md:flex-row justify-center items-center rounded-2xl">
    ...
    <div className="flex flex-col items-center">
      <img className="w-full max-w-[96px] h-auto rounded-full mb-2 object-contain" src={image} alt="Robin" />
      <h2 className="text-lg font-semibold">MD: Robin</h2>
      <p className="text-sm">CEO & Founder</p>
    </div>
    {/* সদস্য ২ */}
    <div className="flex flex-col items-center">
      <img className="w-full max-w-[96px] h-auto rounded-full mb-2 object-contain" src={image2} alt="Elon Musk" />
      <h2 className="text-lg font-semibold">Elon Musk</h2>
      <p className="text-sm">Product Manager</p>
    </div>
    {/* সদস্য ৩ */}
    <div className="flex flex-col items-center">
      <img className="w-full max-w-[96px] h-auto rounded-full mb-2 object-contain" src={image1} alt="Bill Gates" />
