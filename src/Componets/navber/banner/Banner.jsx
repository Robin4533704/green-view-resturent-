...
>
  ...
  <div className="md:mt-4 ml-4 ">
    <div className="text-white -mt-[200px] md:mt-[40px] ">
      <h1 className="mb-5 text-2xl lg:text-5xl  font-bold "><span className='text-green-500'>Green</span> <span className='text-yellow-400'>View</span >Resturent<br />fresh sushi and sashimi.</h1>
