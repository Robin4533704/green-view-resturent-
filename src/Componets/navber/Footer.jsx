...
const Footer = () => {
   const links = <>
    ...
    return (
        <footer className="footer mt-6 footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
 <div className='flex gap-6'>
  {links}
 </div>
  <nav>
    <div className="grid grid-flow-col gap-4">
     <a href="https://twitter.com/yourprofile"> <svg 
      ...
      <a href="https://www.facebook.com/share/1EaXrxVN3H/">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
